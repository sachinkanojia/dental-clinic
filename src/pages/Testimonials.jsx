            ...
            <section className="bg-gradient-hero py-section-gap px-gutter text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="font-body-lg text-body-lg text-on-surface-variant mb-8">
                        Discover why thousands of patients trust Dental Clinic for their smiles. Read genuine experiences highlighting our commitment to clinical excellence and patient comfort.
                    </p>
            ...
            <section className="py-section-gap px-gutter max-w-container-max mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant hover:shadow-md transition-shadow">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant mb-4">
                            "I've always dreaded the dentist, but Dental changed that. Completely <strong className="text-primary font-semibold">Pain-free</strong> root canal. The <strong className="text-primary font-semibold">Friendly staff</strong> held my hand through the anxiety."
                        </p>
