        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center">
          <div className="order-2 lg:order-1 flex flex-col space-y-6">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl">
              At Dental Clinic, we believe a healthy smile is the foundation of overall wellness. We combine state-of-the-art technology with compassionate care to deliver an unparalleled dental experience, right here in the heart of Kenya.
            </p>
