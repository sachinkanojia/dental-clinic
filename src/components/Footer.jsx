    ...
    <footer className="bg-slate-50 dark:bg-slate-950 w-full py-12 border-t border-slate-200 dark:border-slate-800">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-8 max-w-7xl mx-auto">
        <div className="md:col-span-1">
          <span className="text-lg font-black text-[#0F4C81] dark:text-white block mb-4">Dental Clinic</span>
        ...
        <div className="md:col-span-1 flex flex-col justify-end">
          <p className="font-manrope text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-8 md:mt-0">© 2026 Dental Clinic Nairobi. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
